...
Vector4D::Vector4D(float value_)
...
Vector4D::Vector4D(const Vector4D& other_)
    : XMFLOAT4(other_)
{
}

Vector4D::Vector4D(Vector4D&& other_)
    : XMFLOAT4(other_)
{
}

Vector4D Vector4D::operator+(const Vector4D& _other) const
{
    Vector4D result;
...
Vector4D& Vector4D::operator+=(const Vector4D& _other)
{
...
Vector4D Vector4D::operator*(float _scalar) const
{
    Vector4D result;
...
Vector4D& Vector4D::operator*=(float _scalar)
{
...
Vector4D& Vector4D::operator=(Vector4D&& _other)
{
    x = _other.x;
    y = _other.y;
    z = _other.z;
...
bool Vector4D::operator==(const Vector4D& other_) const
{
...
std::partial_ordering Vector4D::operator<=>(const Vector4D& other_) const
{
...
float Vector4D::GetSqrMagnitude() const
{
...
void Vector4D::Set(float x_, float y_, float z_, float w_)
{
    x = x_;
    y = y_;
    z = z_;
...
bool Vector4D::IsZero(float epsilon_) const
{
...
Vector Vector4D::Load(const Vector4D& vec_)
{
    return DirectX::XMLoadFloat4(&vec_);
}

void Vector4D::Store(Vector4D& d_, Vector s_)
{
    DirectX::XMStoreFloat4(&d_, s_);
}

bool Vector4D::IsApproximately(const Vector4D& lhs_, const Vector4D& rhs_, float epsilon_)
{
...
Vector4D Vector4D::Clamp(const Vector4D& value_, const Vector4D& min_, const Vector4D& max_)
{
    return Vector4D(
...
Vector4D Vector4D::ClampMagnitude(const Vector4D& vector_, float maxLength_)
{
...
float Vector4D::Distance(const Vector4D& a_, const Vector4D& b_)
{
    return (a_ - b_).GetMagnitude();
}

Vector4D Vector4D::Scale(const Vector4D& vector_, const Vector4D& scale_)
{
    return Vector4D(vector_.x * scale_.x, vector_.y * scale_.y, vector_.z * scale_.z, vector_.w * scale_.w);
}

Vector4D Vector4D::Normalize(const Vector4D& value_)
{
    Vector4D result;
...
float Vector4D::Dot(const Vector4D& a_, const Vector4D& b_)
{
    return DirectX::XMVectorGetX(DirectX::XMVector4Dot(Load(a_), Load(b_)));
}

Vector4D Vector4D::Lerp(const Vector4D& a_, const Vector4D& b_, float t_)
{
    Vector4D result;
...
Vector4D Vector4D::LerpUnclamped(const Vector4D& a_, const Vector4D& b_, float t_)
{
    Vector4D result;
...
Vector4D Vector4D::Slerp(const Vector4D& a_, const Vector4D& b_, float t_)
{
    return SlerpUnclamped(a_, b_, Mathf::Clamp(t_, 0.0f, 1.0f));
}

Vector4D Vector4D::SlerpUnclamped(const Vector4D& a_, const Vector4D& b_, float t_)
{
...
Vector4D Vector4D::Project(const Vector4D& vector_, const Vector4D& onNormal_)
{
...
Vector4D Vector4D::Reflect(const Vector4D& vector_, const Vector4D& normal_)
{
    return vector_ - normal_ * (2.0f * Dot(vector_, normal_));
}

Vector4D Vector4D::MoveTowards(const Vector4D& current_, const Vector4D& target_, float maxDistanceDelta_)
{
...
Vector4D::Vector4D(const Vector2D& vector_, float z_, float w_)
    : XMFLOAT4(vector_.x, vector_.y, z_, w_)
{
}

Vector4D::Vector4D(const Vector3D& vector_, float w_)
    : XMFLOAT4(vector_.x, vector_.y, vector_.z, w_)
{
}
