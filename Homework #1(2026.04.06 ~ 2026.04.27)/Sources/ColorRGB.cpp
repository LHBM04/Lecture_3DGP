...
ColorRGB::ColorRGB(float value_)
...
ColorRGB::ColorRGB(const Vector3D& vector_)
    : XMFLOAT3(vector_.x, vector_.y, vector_.z)
{
}

ColorRGB::ColorRGB(const Vector4D& vector_)
    : XMFLOAT3(vector_.x, vector_.y, vector_.z)
{
}

ColorRGB::ColorRGB(const ColorRGB& color_)
    : XMFLOAT3(color_)
{
}
...
ColorRGB& ColorRGB::operator=(const ColorRGB& other_)
{
    x = other_.x;
    y = other_.y;
    z = other_.z;
...
ColorRGB ColorRGB::GetBlack()
{
    return ColorRGB(0.0f, 0.0f, 0.0f);
}

ColorRGB ColorRGB::GetWhite()
{
    return ColorRGB(1.0f, 1.0f, 1.0f);
}

ColorRGB ColorRGB::GetRed()
{
    return ColorRGB(1.0f, 0.0f, 0.0f);
}

ColorRGB ColorRGB::GetGreen()
{
    return ColorRGB(0.0f, 1.0f, 0.0f);
}

ColorRGB ColorRGB::GetBlue()
{
    return ColorRGB(0.0f, 0.0f, 1.0f);
}

ColorRGB ColorRGB::GetYellow()
{
    return ColorRGB(1.0f, 1.0f, 0.0f);
}

ColorRGB ColorRGB::GetCyan()
{
    return ColorRGB(0.0f, 1.0f, 1.0f);
}

ColorRGB ColorRGB::GetMagenta()
{
    return ColorRGB(1.0f, 0.0f, 1.0f);
}

ColorRGB ColorRGB::GetGray()
{
    return ColorRGB(0.5f, 0.5f, 0.5f);
}

ColorRGB ColorRGB::GetGrey()
{
    return GetGray();
}

float ColorRGB::LinearToGammaSpace(float value_)
{
    return std::pow(std::max(0.0f, value_), 1.0f / 2.2f);
}

float ColorRGB::GammaToLinearSpace(float value_)
{
    return std::pow(std::max(0.0f, value_), 2.2f);
}

ColorRGB ColorRGB::GetGamma() const
{
    return ColorRGB(
...
ColorRGB ColorRGB::GetLinear() const
{
    return ColorRGB(
...
float ColorRGB::GetGrayscale() const
{
    return 0.299f * x + 0.587f * y + 0.114f * z;
}

float ColorRGB::GetMaxColorComponent() const
{
    return std::max(x, std::max(y, z));
}

ColorRGB ColorRGB::HSVToRGB(float h_, float s_, float v_)
{
    return HSVToRGB(h_, s_, v_, false);
}

ColorRGB ColorRGB::HSVToRGB(float h_, float s_, float v_, bool hdr_)
{
    h_ = h_ - std::floor(h_);
...
void ColorRGB::RGBToHSV(const ColorRGB& rgbColor_, float& h_, float& s_, float& v_)
{
...
ColorRGB ColorRGB::Lerp(const ColorRGB& a_, const ColorRGB& b_, float t_)
{
    return LerpUnclamped(a_, b_, Mathf::Clamp(t_, 0.0f, 1.0f));
}

ColorRGB ColorRGB::LerpUnclamped(const ColorRGB& a_, const ColorRGB& b_, float t_)
{
    return ColorRGB(
...
bool ColorRGB::IsApproximately(const ColorRGB& lhs_, const ColorRGB& rhs_, float epsilon_)
{
...
bool ColorRGB::IsFinite() const
{
    return std::isfinite(x) && std::isfinite(y) && std::isfinite(z);
}

bool ColorRGB::IsHDR() const
{
    return x > 1.0f || y > 1.0f || z > 1.0f;
}

Vector3D ColorRGB::ToVector3D() const
{
    return Vector3D(x, y, z);
}

Vector4D ColorRGB::ToVector4D(float alpha_) const
{
    return Vector4D(x, y, z, alpha_);
}

ColorRGB::ColorRGB(const ColorRGBA& color_)
    : XMFLOAT3(color_.x, color_.y, color_.z)
{
}

ColorRGBA ColorRGB::ToColorRGBA(float alpha_) const
{
