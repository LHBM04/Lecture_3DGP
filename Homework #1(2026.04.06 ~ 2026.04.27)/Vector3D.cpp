...
Vector3D::Vector3D(float value_)
    : XMFLOAT3(value_, value_, value_)
{
}
...
Vector3D::Vector3D(const Vector3D& other_)
    : XMFLOAT3(other_)
{
}

Vector3D::Vector3D(Vector3D&& other_)
    : XMFLOAT3(other_)
{
}

Vector3D Vector3D::operator+(const Vector3D& _other) const
{
    Vector3D result;
...
Vector3D Vector3D::operator*(float _scalar) const
{
    Vector3D result;
...
bool Vector3D::operator==(const Vector3D& other_) const
{
...
std::partial_ordering Vector3D::operator<=>(const Vector3D& other_) const
{
...
float Vector3D::GetSqrMagnitude() const
{
...
bool Vector3D::IsZero(float epsilon_) const
{
...
Vector3D Vector3D::GetPositiveInfinity()
{
    const float infinity{ std::numeric_limits<float>::infinity() };
    return Vector3D(infinity, infinity, infinity);
}

Vector3D Vector3D::GetNegativeInfinity()
{
...
Vector Vector3D::Load(const Vector3D& vec_)
{
    return DirectX::XMLoadFloat3(&vec_);
}

void Vector3D::Store(Vector3D& d_, Vector s_)
{
    DirectX::XMStoreFloat3(&d_, s_);
}

bool Vector3D::IsApproximately(const Vector3D& lhs_, const Vector3D& rhs_, float epsilon_)
{
...
Vector3D Vector3D::Max(const Vector3D& a_, const Vector3D& b_)
{
    return Vector3D(std::max(a_.x, b_.x), std::max(a_.y, b_.y), std::max(a_.z, b_.z));
}

Vector3D Vector3D::Min(const Vector3D& a_, const Vector3D& b_)
{
    return Vector3D(std::min(a_.x, b_.x), std::min(a_.y, b_.y), std::min(a_.z, b_.z));
}

float Vector3D::Angle(const Vector3D& a_, const Vector3D& b_)
{
...
float Vector3D::SignedAngle(const Vector3D& from_, const Vector3D& to_, const Vector3D& axis_)
{
...
Vector3D Vector3D::Clamp(const Vector3D& value_, const Vector3D& min_, const Vector3D& max_)
{
    return Vector3D(
...
Vector3D Vector3D::ClampMagnitude(const Vector3D& vector_, float maxLength_)
{
...
float Vector3D::Distance(const Vector3D& _v1, const Vector3D& _v2)
{
    return (_v1 - _v2).GetMagnitude();
}

Vector3D Vector3D::Scale(const Vector3D& vector_, const Vector3D& scale_)
{
    return Vector3D(vector_.x * scale_.x, vector_.y * scale_.y, vector_.z * scale_.z);
}

Vector3D Vector3D::Normalize(const Vector3D& value_)
{
    Vector3D res;
...
Vector3D Vector3D::Lerp(const Vector3D& a_, const Vector3D& b_, float t_)
{
    Vector3D res;
...
Vector3D Vector3D::LerpUnclamped(const Vector3D& a_, const Vector3D& b_, float t_)
{
    Vector3D res;
...
Vector3D Vector3D::Slerp(const Vector3D& a_, const Vector3D& b_, float t_)
{
    return SlerpUnclamped(a_, b_, Mathf::Clamp(t_, 0.0f, 1.0f));
}

Vector3D Vector3D::SlerpUnclamped(const Vector3D& a_, const Vector3D& b_, float t_)
{
...
Vector3D Vector3D::Cross(const Vector3D& a_, const Vector3D& b_)
{
    Vector3D res;
...
float Vector3D::Dot(const Vector3D& a_, const Vector3D& b_)
{
    return DirectX::XMVectorGetX(DirectX::XMVector3Dot(Load(a_), Load(b_)));
}

Vector3D Vector3D::Project(const Vector3D& vector_, const Vector3D& onNormal_)
{
...
Vector3D Vector3D::ProjectOnPlane(const Vector3D& vector_, const Vector3D& planeNormal_)
{
    return vector_ - Project(vector_, planeNormal_);
}

Vector3D Vector3D::Reflect(const Vector3D& _vector, const Vector3D& _normal)
{
    Vector3D res;
...
Vector3D Vector3D::Refract(const Vector3D& _vector, const Vector3D& _normal, float _eta)
{
    Vector3D res;
...
void Vector3D::OrthoNormalize(Vector3D& normal_, Vector3D& tangent_)
{
...
void Vector3D::OrthoNormalize(Vector3D& normal_, Vector3D& tangent_, Vector3D& binormal_)
{
...
Vector3D::Vector3D(const Vector2D& vector_, float z_)
    : XMFLOAT3(vector_.x, vector_.y, z_)
{
}

Vector3D::Vector3D(const Vector4D& vector_)
    : XMFLOAT3(vector_.x, vector_.y, vector_.z)
{
}
...
Vector3D Vector3D::MoveTowards(const Vector3D& current_, const Vector3D& target_, float maxDistanceDelta_)
{
...
Vector3D Vector3D::RotateTowards(const Vector3D& current_, const Vector3D& target_, float maxRadiansDelta_, float maxMagnitudeDelta_)
{
